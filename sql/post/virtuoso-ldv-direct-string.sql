...
prefix iri: <http://www.openlinksw.com/schemas/virtrdf/string#>
...
create quad storage virtrdf:NeXtProtStringQuadStorage
...
{
  create virtrdf:NeXtProtString as graph iri ("http://nextprot.org/rdf")
  {
