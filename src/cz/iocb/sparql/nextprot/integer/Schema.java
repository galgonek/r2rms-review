...
public class Schema
{
    ...
    {
        config.addIriClass(new MapUserIriClass("source", "integer", new Table("nextprot", "source_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/source/", 0));
        config.addIriClass(new MapUserIriClass("database", "integer", new Table("nextprot", "database_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/db/", 0));
        config.addIriClass(new MapUserIriClass("schema", "integer", new Table("nextprot", "schema_bases"),
