...
public class Chromosome
{
    ...
    {
        config.addIriClass(new MapUserIriClass("isoform", "integer", new Table("nextprot", "isoform_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/isoform/", 0));
        config.addIriClass(new MapUserIriClass("annotation", "integer", new Table("nextprot", "annotation_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/annotation/", 0));
        config.addIriClass(new MapUserIriClass("evidence", "integer", new Table("nextprot", "evidence_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/evidence/", 0));
        config.addIriClass(new MapUserIriClass("entry", "integer", new Table("nextprot", "entry_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/entry/", 0));
        config.addIriClass(new MapUserIriClass("proteoform", "integer", new Table("nextprot", "proteoform_bases"),
                new TableColumn("id"), new TableColumn("iri"), "http://nextprot.org/rdf/proteoform/", 0));
        config.addIriClass(new MapUserIriClass("gene", "integer", new Table("nextprot", "gene_bases"),
